...
/*  Una pila es una versión restringida de una lista ligada
Los nuevos nodos pueden añadirse y eliminarse de una pila sólo en la cima.
LIFO: Last In First Out ó Última en entrar, primera en salir (UEPS).

ejemplo de uso: llamadas a funciones 
*/

/*
El programa proporciona tres opciones: 
1) introducir un valor en la pila (función empujar), 
2) eliminar un valor de la pila (función sacar), y 
